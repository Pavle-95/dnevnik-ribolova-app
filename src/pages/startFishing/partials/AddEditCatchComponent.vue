<script setup>
  ...
  const emit = defineEmits(['closeModal', 'submitCatch'])
   ...
   <span class="heading-close-btn">
    ...
    <div class="form-holder">
      <div class="input-holder">
        ...
        <input v-model="fish.fishType" placeholder="Vrsta ribe" type="text">
      </div>
      <div class="input-holder">
        <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <input v-model="fish.fishWeight" placeholder="Tezina Ribe" type="number">
      </div>
      <div class="input-holder">
        <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <input v-model="fish.baitType" placeholder="Vrsta Mamca" type="text">
      </div>
      <div class="input-holder">
        ...
        <input v-model="fish.location" placeholder="Ribolovna Voda" type="text">
      </div>
    </div>
    <button class="submit-catch" @click="() => emit('submitCatch')">
      Dodaj ulov
    </button>
</template>
